...
export default class ScaleEnhancedHexagonLayer extends HexagonLayer<any> {
    static defaultProps: {
        ...
        hexagonAggregator?: ({
            ...
            type: "image";
            parameters?: any;
        }) | ((position: number[], radius: number) => [number, number]) | ({
            value: ((position: number[], radius: number) => [number, number]) | null;
            async?: boolean;
            validate?: (value: any, propType: import("@deck.gl/core/dist/lifecycle/prop-types").PropType) => boolean;
            equal?: ((value1: ((position: number[], radius: number) => [number, number]) | null, value2: ((position: number[], radius: number) => [number, number]) | null, propType: import("@deck.gl/core/dist/lifecycle/prop-types").PropType) => boolean) | undefined;
        } & {
            type: "data";
        }) | ({
            value: ((position: number[], radius: number) => [number, number]) | null;
        ...
        elevationScaleType?: ("linear" | {
            ...
            async?: boolean;
            validate?: (value: any, propType: import("@deck.gl/core/dist/lifecycle/prop-types").PropType) => boolean;
            equal?: ((value1: "linear", value2: "linear", propType: import("@deck.gl/core/dist/lifecycle/prop-types").PropType) => boolean) | undefined;
        } & {
            type: "data";
        }) | ({
            value: "linear";
