import { Feature, LineString, Point, Position } from "./geojson-types.js";
import { Viewport } from "./types.js";
export type NearestPointType = Feature<Point, {
    dist: number;
    index: number;
}>;
...
export declare function nearestPointOnProjectedLine(line: Feature<LineString>, inPoint: Feature<Point>, viewport: Viewport): NearestPointType;
/**
