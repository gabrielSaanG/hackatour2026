import { Position, Polygon, Feature } from "../utils/geojson-types.js";
...
export declare class DrawEllipseUsingThreePointsMode extends ThreeClickPolygonMode {
    getThreeClickPolygon(coord1: Position, coord2: Position, coord3: Position, modeConfig: any): Feature<Polygon> | null | undefined;
}
