...
var __exports__ = (() => {
  ...
  var objectid = createCommonjsModule(function(module, exports) {
    ...
    Object.defineProperty(ObjectId.prototype, inspect2, ObjectId.prototype.toString);
  ...
  var deserializer = createCommonjsModule(function(module, exports) {
    ...
    const functionCache = {};
    function deserialize(buffer2, options, isArray2) {
  ...
  var float_parser = createCommonjsModule(function(module, exports) {
    ...
    function readIEEE754(buffer2, offset, endian, mLen, nBytes) {
      let e;
      let m;
  ...
  var serializer = createCommonjsModule(function(module, exports) {
    ...
    function serializeString(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_STRING;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes + 1;
      buffer2[index - 1] = 0;
      const size = buffer2.write(value, index + 4, void 0, "utf8");
    ...
    function serializeNumber(buffer2, key, value, index, isArray2) {
      if (Number.isInteger(value) && value >= constants.BSON_INT32_MIN && value <= constants.BSON_INT32_MAX) {
        buffer2[index++] = constants.BSON_DATA_INT;
        const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
        ...
        buffer2[index++] = constants.BSON_DATA_NUMBER;
        const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
        index = index + numberOfWrittenBytes;
        buffer2[index++] = 0;
        float_parser.writeIEEE754(buffer2, value, index, "little", 52, 8);
        index = index + 8;
      }
      return index;
    }
    function serializeNull(buffer2, key, _, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_NULL;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
      return index;
    }
    function serializeBoolean(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_BOOLEAN;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
    ...
    function serializeDate(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_DATE;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
    ...
    function serializeRegExp(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_REGEXP;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
    ...
    function serializeBSONRegExp(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_REGEXP;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
    ...
    function serializeMinMax(buffer2, key, value, index, isArray2) {
      if (value === null) {
        buffer2[index++] = constants.BSON_DATA_NULL;
      } else if (value._bsontype === "MinKey") {
        buffer2[index++] = constants.BSON_DATA_MIN_KEY;
      } else {
        buffer2[index++] = constants.BSON_DATA_MAX_KEY;
      }
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
    ...
    function serializeObjectId(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_OID;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
      if (typeof value.id === "string") {
        ...
        value.id.copy(buffer2, index, 0, 12);
      } else {
        throw new TypeError("object [" + JSON.stringify(value) + "] is not a valid ObjectId");
      }
      return index + 12;
    }
    function serializeBuffer(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_BINARY;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
      ...
      buffer2[index++] = constants.BSON_BINARY_SUBTYPE_DEFAULT;
      buffer2.set(ensure_buffer.ensureBuffer(value), index);
      index = index + size;
      return index;
    }
    function serializeObject(buffer2, key, value, index, checkKeys = false, depth = 0, serializeFunctions = false, ignoreUndefined = true, isArray2 = false, path = []) {
      for (let i = 0; i < path.length; i++) {
        if (path[i] === value)
          throw new Error("cyclic dependency detected");
      }
      path.push(value);
      buffer2[index++] = Array.isArray(value) ? constants.BSON_DATA_ARRAY : constants.BSON_DATA_OBJECT;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
    ...
    function serializeDecimal128(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_DECIMAL128;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
      value.bytes.copy(buffer2, index, 0, 16);
      return index + 16;
    }
    function serializeLong(buffer2, key, value, index, isArray2) {
      buffer2[index++] = value._bsontype === "Long" ? constants.BSON_DATA_LONG : constants.BSON_DATA_TIMESTAMP;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
    ...
    function serializeInt32(buffer2, key, value, index, isArray2) {
      value = value.valueOf();
      buffer2[index++] = constants.BSON_DATA_INT;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
    ...
    function serializeDouble(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_NUMBER;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
      float_parser.writeIEEE754(buffer2, value.value, index, "little", 52, 8);
      index = index + 8;
      return index;
    }
    function serializeFunction(buffer2, key, value, index, _checkKeys = false, _depth = 0, isArray2) {
      buffer2[index++] = constants.BSON_DATA_CODE;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
      const functionString = utils.normalizedFunctionString(value);
      const size = buffer2.write(functionString, index + 4, void 0, "utf8") + 1;
      buffer2[index] = size & 255;
    ...
    function serializeCode(buffer2, key, value, index, checkKeys = false, depth = 0, serializeFunctions = false, ignoreUndefined = true, isArray2 = false) {
      if (value.scope && typeof value.scope === "object") {
        buffer2[index++] = constants.BSON_DATA_CODE_W_SCOPE;
        const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
        index = index + numberOfWrittenBytes;
        buffer2[index++] = 0;
        ...
        index = index + 4;
        const codeSize = buffer2.write(functionString, index + 4, void 0, "utf8") + 1;
        ...
        const endIndex = serializeInto(buffer2, value.scope, checkKeys, index, depth + 1, serializeFunctions, ignoreUndefined);
        index = endIndex - 1;
    ...
    function serializeBinary(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_BINARY;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
    ...
    function serializeSymbol(buffer2, key, value, index, isArray2) {
      buffer2[index++] = constants.BSON_DATA_SYMBOL;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
      const size = buffer2.write(value.value, index + 4, void 0, "utf8") + 1;
      buffer2[index] = size & 255;
      buffer2[index + 1] = size >> 8 & 255;
      buffer2[index + 2] = size >> 16 & 255;
      buffer2[index + 3] = size >> 24 & 255;
    ...
    function serializeDBRef(buffer2, key, value, index, depth, serializeFunctions, isArray2) {
      buffer2[index++] = constants.BSON_DATA_OBJECT;
      const numberOfWrittenBytes = !isArray2 ? buffer2.write(key, index, void 0, "utf8") : buffer2.write(key, index, void 0, "ascii");
      index = index + numberOfWrittenBytes;
      buffer2[index++] = 0;
      let startIndex = index;
      ...
      const endIndex = serializeInto(buffer2, output, false, index, depth + 1, serializeFunctions);
  ...
  var bson = createCommonjsModule(function(module, exports) {
    ...
    Object.defineProperty(exports, "JS_INT_MAX", { enumerable: true, get: function() {
      return constants.JS_INT_MAX;
    } });
    Object.defineProperty(exports, "JS_INT_MIN", { enumerable: true, get: function() {
    ...
    function deserialize(buffer2, options = {}) {
      return deserializer.deserialize(ensure_buffer.ensureBuffer(buffer2), options);
    }
    exports.deserialize = deserialize;
  ...
  function parseBSONSync(value, options) {
    const parsedData = bson_3(new Uint8Array(value), options);
    return parsedData;
  }
