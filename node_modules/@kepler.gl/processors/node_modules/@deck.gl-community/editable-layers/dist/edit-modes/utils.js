...
export function generatePointsParallelToLinePoints(p1, p2, coords) {
    const lineString = {
        type: 'LineString',
        coordinates: [p1, p2]
    };
 ...
 */
export function updateRectanglePosition(feature, editHandleIndex, coords) {
...
export function shouldCancelPan(event) {
