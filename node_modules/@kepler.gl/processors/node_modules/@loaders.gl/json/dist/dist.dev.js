...
return true;`);
  ...
  // ../schema-utils/src/lib/table/tables/make-table.ts
...
Char: ${this.c}`;
  ...
  // ../gis/src/lib/feature-collection-converters/convert-geojson-to-flat-geojson.ts
  ...
  // ../gis/src/lib/feature-collection-converters/convert-geojson-to-binary-features.ts
  ...
  function parseTextSync2(text, options) {
    ...
    switch (options.gis.format) {
      case "binary":
        return convertGeojsonToBinaryFeatureCollection(table.features);
      default:
        return table;
    }
  }
  ...
  async function* makeBinaryGeometryIterator(geojsonIterator) {
    for await (const batch of geojsonIterator) {
      batch.data = convertGeojsonToBinaryFeatureCollection(batch.data);
      yield batch;
    }
  }
