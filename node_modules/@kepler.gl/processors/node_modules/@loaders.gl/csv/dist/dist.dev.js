...
return true;`);
    ...
    for (let rowIndex = 0; rowIndex < length; rowIndex++) {
      for (let columnIndex = 0; columnIndex < numColumns; ++columnIndex) {
        ...
        if (batchLength >= batchSize) {
          ...
          yield new RecordBatch3(arrowSchema, structData);
          batchLength = 0;
        }
      }
    }
  ...
  // ../schema-utils/src/lib/table/tables/row-utils.ts
  ...
  // ../schema-utils/src/lib/table/batches/convert-batches.ts
  ...
  // ../schema-utils/src/lib/table/batch-builder/base-table-batch-aggregator.ts
  ...
  // ../schema-utils/src/lib/table/batch-builder/row-table-batch-aggregator.ts
  ...
  // ../schema-utils/src/lib/table/batch-builder/columnar-table-batch-aggregator.ts
  ...
  // ../schema-utils/src/lib/table/batch-builder/arrow-table-batch-aggregator.ts
  ...
  // ../schema-utils/src/lib/table/batch-builder/table-batch-builder.ts
  var DEFAULT_OPTIONS = {
    shape: void 0,
    batchSize: "auto",
    batchDebounceMs: 0,
  ...
  // ../schema-utils/src/lib/utils/async-queue.ts
  ...
  // src/papaparse/papa-constants.ts
  var BYTE_ORDER_MARK = "\uFEFF";
  var Papa = {
  ...
  var ParserHandle = class {
    ...
    parse(input, baseIndex, ignoreLastRow) {
      ...
      } else if (isFunction2(this._config.delimiter)) {
    ...
    fillHeaderFields() {
      ...
      const addHeder = (header) => {
        if (isFunction2(this._config.transformHeader))
  ...
  function Parser(config = {}) {
    ...
    this.parse = function(input, baseIndex, ignoreLastRow) {
      ...
      const stepIsFunction = isFunction2(step);
      cursor = 0;
      let data = [];
      let errors = [];
      let row = [];
