...
export declare const durationMillisecond = 1;
...
export declare const DURATIONS: Durations;
export declare const TIME_INTERVALS: TimeIntervals;
export declare const INTERVAL: Interval;
export declare const WOW: {
    [key: ValueOf<Interval>]: number;
};
export declare const INTERVAL_OPTIONS: IntervalOption[];
export declare const TICK_INTERVALS: TickIntervals;
export declare const PLOT_TYPE_OPTIONS: {
    lineChart: {
        id: "lineChart";
        label: string;
        icon: string;
...
export declare const BINS_LARGE = 100;
export declare const BINS = 30;
export declare const TIME_AGGREGATION: TimeAggregation[];
export declare const ANIMATION_TYPE: AnimationType;
