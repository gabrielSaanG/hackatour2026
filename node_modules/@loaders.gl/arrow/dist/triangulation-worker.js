...
(() => {
  ...
  var adapters_default = {
    ...
    // @ts-ignore
    toDOMStream(source, options2) {
      throw new Error(`"toDOMStream" not available in this environment`);
    },
    // @ts-ignore
    toNodeStream(source, options2) {
...
return true;`);
  ...
  var Builder2 = class {
    /** @nocollapse */
    // @ts-ignore
    static throughNode(options2) {
      throw new Error(`"throughNode" not available in this environment`);
    }
    /** @nocollapse */
    // @ts-ignore
    static throughDOM(options2) {
  ...
  var ReadableInterop = class {
    ...
    pipe(writable, options2) {
      return this._getNodeStream().pipe(writable, options2);
    }
    pipeTo(writable, options2) {
      return this._getDOMStream().pipeTo(writable, options2);
    }
    pipeThrough(duplex, options2) {
      return this._getDOMStream().pipeThrough(duplex, options2);
    }
    _getDOMStream() {
  ...
  var AsyncQueue = class extends ReadableInterop {
    ...
    toDOMStream(options2) {
      return adapters_default.toDOMStream(this._closedPromiseResolve || this._error ? this : this._values, options2);
    }
    toNodeStream(options2) {
      return adapters_default.toNodeStream(this._closedPromiseResolve || this._error ? this : this._values, options2);
    }
    throw(_) {
      return __awaiter(this, void 0, void 0, function* () {
        yield this.abort(_);
  ...
  var UnionBuilder = class extends Builder2 {
    constructor(options2) {
      ...
      if (typeof options2["valueToChildTypeId"] === "function") {
        this._valueToChildTypeId = options2["valueToChildTypeId"];
      }
    }
  ...
  function makeBuilder(options2) {
    const type = options2.type;
    const builder = new (instance6.getVisitFn(type)())(options2);
    if (type.children && type.children.length > 0) {
      const children = options2["children"] || [];
      const defaultOptions = { "nullValues": options2["nullValues"] };
  ...
  var RecordBatchReader = class extends ReadableInterop {
    ...
    open(options2) {
      const opening = this._impl.open(options2);
  ...
  var RecordBatchStreamReaderImpl = class extends RecordBatchReaderImpl {
    ...
    open(options2) {
      if (!this.closed) {
        this.autoDestroy = shouldAutoDestroy(this, options2);
  ...
  var AsyncRecordBatchFileReaderImpl = class extends AsyncRecordBatchStreamReaderImpl {
    ...
    open(options2) {
      ...
      return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield _super.open.call(this, options2);
      });
    }
    readRecordBatch(index) {
      return __awaiter(this, void 0, void 0, function* () {
  ...
  function shouldAutoDestroy(self2, options2) {
    return options2 && typeof options2["autoDestroy"] === "boolean" ? options2["autoDestroy"] : self2["autoDestroy"];
  }
  ...
  var RecordBatchWriter = class extends ReadableInterop {
    ...
    constructor(options2) {
      ...
      isObject(options2) || (options2 = { autoDestroy: true, writeLegacyIpcFormat: false, compressionType: null });
      this._autoDestroy = typeof options2.autoDestroy === "boolean" ? options2.autoDestroy : true;
      this._writeLegacyIpcFormat = typeof options2.writeLegacyIpcFormat === "boolean" ? options2.writeLegacyIpcFormat : false;
      if (options2.compressionType != null) {
        ...
        if (Object.values(CompressionType).includes(options2.compressionType)) {
          this._compression = new BodyCompression2(options2.compressionType);
        } else {
          const validCompressionTypes = Object.values(CompressionType).filter((v) => typeof v === "string");
          throw new Error(`Unsupported compressionType: ${options2.compressionType} Available types: ${validCompressionTypes.join(", ")}`);
        }
      } else {
        this._compression = null;
      }
    ...
    toDOMStream(options2) {
      return this._sink.toDOMStream(options2);
    }
    toNodeStream(options2) {
      return this._sink.toNodeStream(options2);
    }
    close() {
  ...
  var RecordBatchStreamWriter = class extends RecordBatchWriter {
    /** @nocollapse */
    static writeAll(input, options2) {
      const writer = new RecordBatchStreamWriter(options2);
      if (isPromise(input)) {
  ...
  var RecordBatchFileWriter = class extends RecordBatchWriter {
    /** @nocollapse */
    static writeAll(input, options2) {
      const writer = new RecordBatchFileWriter(options2);
      if (isPromise(input)) {
        return input.then((x) => writer.writeAll(x));
      } else if (isAsyncIterable(input)) {
        return writeAllAsync(writer, input);
  ...
  function toDOMStream(source, options2) {
    if (isAsyncIterable(source)) {
      return asyncIterableAsReadableDOMStream(source, options2);
    }
    if (isIterable(source)) {
      return iterableAsReadableDOMStream(source, options2);
    }
    throw new Error(`toDOMStream() must be called with an Iterable or AsyncIterable`);
  }
  function iterableAsReadableDOMStream(source, options2) {
    let it = null;
    const bm = (options2 === null || options2 === void 0 ? void 0 : options2.type) === "bytes" || false;
    const hwm = (options2 === null || options2 === void 0 ? void 0 : options2.highWaterMark) || Math.pow(2, 24);
    return new ReadableStream(Object.assign(Object.assign({}, options2), {
      start(controller) {
    ...
    }), Object.assign({ highWaterMark: bm ? hwm : void 0 }, options2));
  ...
  function asyncIterableAsReadableDOMStream(source, options2) {
    let it = null;
    const bm = (options2 === null || options2 === void 0 ? void 0 : options2.type) === "bytes" || false;
    const hwm = (options2 === null || options2 === void 0 ? void 0 : options2.highWaterMark) || Math.pow(2, 24);
    return new ReadableStream(Object.assign(Object.assign({}, options2), {
  ...
  function builderThroughDOMStream(options2) {
    return new BuilderTransform(options2);
  }
  var BuilderTransform = class {
    constructor(options2) {
      ...
      const { ["readableStrategy"]: readableStrategy, ["writableStrategy"]: writableStrategy, ["queueingStrategy"]: queueingStrategy = "count" } = options2, builderOptions = __rest(options2, ["readableStrategy", "writableStrategy", "queueingStrategy"]);
  ...
  function convertGeoArrowToBinaryFeatureCollection(geoColumn, geoEncoding, options2) {
    ...
    const chunks = options2?.chunkIndex !== void 0 && options2?.chunkIndex >= 0 ? [geoColumn.data[options2?.chunkIndex]] : geoColumn.data;
    let bounds = [Infinity, Infinity, -Infinity, -Infinity];
    let globalFeatureIdOffset = options2?.chunkOffset || 0;
    const binaryGeometries = [];
    chunks.forEach((chunk) => {
      const { featureIds, flatCoordinateArray, nDim, geomOffset, triangles } = getBinaryGeometriesFromChunk(chunk, geoEncoding, options2);
  ...
  function getBinaryGeometriesFromChunk(chunk, geoEncoding, options2) {
    switch (geoEncoding) {
      case "geoarrow.point":
      ...
      case "geoarrow.multipolygon":
        return getBinaryPolygonsFromChunk(chunk, geoEncoding, options2);
      default:
  ...
  function getBinaryPolygonsFromChunk(chunk, geoEncoding, options2) {
