...
var PMTilesTileSource = class extends import_loader_utils.DataSource {
  ...
  constructor(data, options) {
    ...
    const urlOrBlob = typeof data === "string" ? (0, import_loader_utils.resolvePath)(data) : new BlobSource(data, "pmtiles");
  ...
  async getMetadata() {
    ...
    if (this.options.attributions) {
      metadata.attributions = [
        ...((_a = this.options.core) == null ? void 0 : _a.attributions) || [],
        ...metadata.attributions || []
      ];
    }
