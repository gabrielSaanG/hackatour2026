...
export declare const WKBWriter: {
    ...
    readonly mimeTypes: ["application/wkb", "application/octet-stream"];
    readonly options: {
        readonly wkb: {
            readonly hasZ: false;
            readonly hasM: false;
    ...
    readonly encode: (data: Geometry | Feature, options?: WKBWriterOptions) => Promise<ArrayBuffer>;
    readonly encodeSync: (data: Geometry | Feature, options?: WKBWriterOptions) => ArrayBuffer;
};
