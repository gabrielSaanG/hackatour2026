...
export declare function updateAggregationByField(field: Field, aggregation: ValueOf<AggregationTypes>): ValueOf<"mode" | "sum" | "minimum" | "maximum" | "count" | "average" | "median" | "stdev" | "variance" | "countUnique">;
...
export declare function adjustValueToAnimationWindow<S extends MinVisStateForAnimationWindow>(state: S, filter: TimeRangeFilter): {
    ...
    enabled: boolean;
    fixedDomain: boolean;
    view: import("types/reducers").FilterViewType;
    isAnimating: boolean;
    speed: number;
    ...
    syncTimelineMode: import("types/reducers").SyncTimelineMode;
