...
export declare const DEFAULT_MAP_STYLES: {
    ...
    layerGroups: import("types/reducers").LayerGroup[];
    accessToken?: string | undefined;
    custom?: import("types/reducers").CustomStyleType | undefined;
...
export declare const FIELD_OPTS: {
    ...
    integer: {
        ...
        scale: {
            ...
            color: ("custom" | "customOrdinal" | "quantile" | "quantize")[];
            radius: "sqrt"[];
            size: ("log" | "linear" | "sqrt")[];
        };
        format: {
