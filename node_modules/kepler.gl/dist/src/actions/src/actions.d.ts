...
export type ActionHandlers<T extends {
    [k: string]: Handler;
}> = {
 ...
 * );
 */
export declare const addDataToMap: (data: AddDataToMapPayload) => {
 ...
 * @public
 */
export declare const resetMapConfig: () => {
    type: typeof ActionTypes.RESET_MAP_CONFIG;
};
 ...
 */
export declare const receiveMapConfig: (config: ReceiveMapConfigPayload['config'], options: ReceiveMapConfigPayload['options']) => {
 ...
 * @public
 */
export declare const keplerGlInit: (options?: KeplerGlInitPayload) => {
 ...
 * @public
 */
export declare const replaceDataInMap: (payload: ReplaceDataInMapPayload) => {
