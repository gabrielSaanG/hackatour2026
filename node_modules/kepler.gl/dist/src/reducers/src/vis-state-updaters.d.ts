...
export declare const setFilterViewUpdater: (state: VisState, action: VisStateActions.SetFilterViewUpdaterAction) => {
    filters: Filter[];
    mapInfo: import("types/reducers").MapInfo;
    layers: Layer[];
    layerData: any[];
    layerToBeMerged: any[];
    layerOrder: string[];
    effects: import("types/effects").Effect[];
    effectOrder: string[];
    ...
    editor: Editor;
    splitMaps: import("types/reducers").SplitMap[];
    splitMapsToBeMerged: import("types/reducers").SplitMap[];
    fileLoading: import("types/reducers").FileLoading | false;
    fileLoadingProgress: import("types/reducers").FileLoadingProgress;
