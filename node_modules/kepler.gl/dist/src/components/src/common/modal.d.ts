...
declare const StyledModal: import("styled-components").IStyledComponent<"web", import("styled-components/dist/types").FastOmit<ModalDialogOwnProps & Omit<Modal.Props, "style" | "className" | "ariaHideApp"> & React.RefAttributes<ModalDialog>, never>> & Omit<typeof ModalDialog, keyof React.Component<any, {}, any>>;
