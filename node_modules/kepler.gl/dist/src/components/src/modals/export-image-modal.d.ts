...
declare const ExportImageModalFactory: () => React.FC<import("react-intl").WithIntlProps<ExportImageModalProps>> & {
    WrappedComponent: React.ComponentType<ExportImageModalProps>;
};
