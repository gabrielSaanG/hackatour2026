...
export type GeoArrowArcLayerProps = Omit<ArcLayerProps<any>, 'data' | 'getSourcePosition' | 'getTargetPosition' | 'getSourceColor' | 'getTargetColor' | 'getWidth' | 'getHeight' | 'getTilt'> & _GeoArrowArcLayerProps & CompositeLayerProps;
