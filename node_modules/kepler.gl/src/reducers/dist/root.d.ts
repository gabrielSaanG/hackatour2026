import { KeplerGlState } from './core';
type KeplerGlStateMap = {
    [id: string]: Partial<KeplerGlState>;
};
export declare function provideInitialState(initialState: any, extraReducers?: any): (state: {} | undefined, action: any) => KeplerGlStateMap;
/**
