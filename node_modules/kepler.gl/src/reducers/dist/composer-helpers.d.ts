...
export declare function with_<State>(fn: Arg<State>): (state: State) => State;
...
export declare function map_<X, T>(fn: (state: X) => T): (arr: X[]) => T[];
export declare function filterOutById<X extends {
    id: string;
}>(id: string): (arr: X[]) => X[];
export declare function removeElementAtIndex<X>(index: number): (arr: X[]) => X[];
export {};
