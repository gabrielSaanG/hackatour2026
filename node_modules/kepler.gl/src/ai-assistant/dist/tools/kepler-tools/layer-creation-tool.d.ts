...
export declare const addLayer: import("@openassistant/utils").ExtendedTool<z.ZodObject<{
    ...
    layerType: z.ZodEnum<["point", "arc", "line", "grid", "hexagon", "geojson", "cluster", "heatmap", "h3", "trip", "s2"]>;
...
export declare function guessDefaultLayer(dataset: KeplerTable, layerType: string): import("@kepler.gl/layers").Layer | import("@kepler.gl/layers/dist/hexagon-layer/hexagon-layer").default | null;
