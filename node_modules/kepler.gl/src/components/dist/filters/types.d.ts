...
import { Filter, MultiSelectFilter, RangeFilter, SelectFilter, TimeRangeFilter, Timeline, AnimationConfig } from '@kepler.gl/types';
import { Layer } from '@kepler.gl/layers';
import { ActionHandler, setFilterAnimationTime, setFilterAnimationWindow, setTimeFilterSyncTimelineMode, setFilterPlot, toggleFilterAnimation, updateFilterAnimationSpeed } from '@kepler.gl/actions';
